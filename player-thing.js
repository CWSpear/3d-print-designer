...
const TOTAL_WIDTH = CARD_SLOT_PADDING + OTHER_CARD_WIDTH + CARD_SLOT_PADDING + PLAYER_CARD_WIDTH + CARD_SLOT_PADDING + OTHER_CARD_WIDTH + CARD_SLOT_PADDING;

const TOTAL_HEIGHT = PLAYER_CARD_HEIGHT + CARD_SLOT_PADDING + TOKEN_AREA_HEIGHT + CARD_SLOT_PADDING + CARD_SLOT_SPACING + CARD_SLOT_SPACING + CARD_SLOT_PADDING;
...
function makeTokenArea() {
  ...
  return translate([CARD_SLOT_PADDING + OTHER_CARD_WIDTH + CARD_SLOT_PADDING, PLAYER_CARD_HEIGHT + CARD_SLOT_PADDING, TOTAL_DEPTH - TOKEN_AREA_DEPTH], shape);
}
